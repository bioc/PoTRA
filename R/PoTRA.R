...
#'   \item{Pathway.database}{Object contains gene lists from KEGG, Reactome, Biocarta and PharmGKB databases, and these are made available through the devel graphite library.}
